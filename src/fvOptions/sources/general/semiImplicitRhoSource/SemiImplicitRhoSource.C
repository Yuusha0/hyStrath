...
#include "SemiImplicitRhoSource.H"
#include "fvMesh.H"
...
template<class Type>
const Foam::wordList Foam::fv::SemiImplicitRhoSource<Type>::volumeModeTypeNames_
(
...
template<class Type>
typename Foam::fv::SemiImplicitRhoSource<Type>::volumeModeType
Foam::fv::SemiImplicitRhoSource<Type>::wordToVolumeModeType
(
    const word& vmtName
) const
{
...
template<class Type>
Foam::word Foam::fv::SemiImplicitRhoSource<Type>::volumeModeTypeToWord
(
...
template<class Type>
void Foam::fv::SemiImplicitRhoSource<Type>::setFieldData(const dictionary& dict)
{
...
template<class Type>
Foam::fv::SemiImplicitRhoSource<Type>::SemiImplicitRhoSource
(
    const word& name,
...
template<class Type>
void Foam::fv::SemiImplicitRhoSource<Type>::addSup
(
    fvMatrix<Type>& eqn,
    const label fieldi
)
{
    if (debug)
    {
        Info<< "SemiImplicitRhoSource<" << pTraits<Type>::typeName
...
)
{
	...
	injectionRate_[fieldi].first()/VDash_;
	...
	injectionRate_[fieldi].second()/VDash_;
